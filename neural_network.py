...
class NeuralNetwork:
    ...
    def __init__(self):
        ...
        self.learning_rate = 0.5  # Скорость обучения нейросети
        self.momentum = 0.5  # Момент для метода обратного распространения
        self.epochs = 20000  # Количество эпох обучения
